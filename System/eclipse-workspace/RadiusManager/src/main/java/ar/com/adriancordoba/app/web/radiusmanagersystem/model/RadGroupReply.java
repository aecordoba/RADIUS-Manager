...
public class RadGroupReply {
	 ...
	 * @param value
	 */
	public RadGroupReply(Integer id, String userName, String attribute, String operator, String value) {
		super();
		this.id = id;
	 ...
	 * @param value
	 */
	public RadGroupReply(String userName, String attribute, String operator, String value) {
		super();
		this.userName = userName;
		this.attribute = attribute;
		this.operator = operator;
